                ...
                <fieldset class="wizard-fieldset show">
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-12 col-lg-4">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control wizard-required" id="force_no" name="force_no" placeholder="Force Number">
                                <div class="wizard-form-error"></div>
                            </div>
                        </div>
                ...
                <fieldset class="wizard-fieldset " >
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-lg-6">
                            ...
                            <select name="type" id="type" class="form-select select2 wizard-required" onchange="toggleFields(this.value)" required>
...
<fieldset class="wizard-fieldset" >
    ...
    <div class="row g-3">
        ...
        <div class="col-12 col-lg-6">
            ...
            <select class="form-control select2 wizard-required" id="region" name="region_id" required onchange="updateDistricts()">
...
<!-- Command Selection (Only for admin, registrar_hq, and superuser) -->
       @if(auth()->user()->hasRole(['admin', 'registrar_hq', 'superadmin']))
        <div class="col-12 col-lg-6">
            ...
            <select class="form-control select2" id="command_id" name="command_id">
...
<fieldset class="wizard-fieldset" >
    ...
    <div class="row g-3">
        ...
        <div class="col-12 col-lg-6">
            ...
            <select class="form-control select2 wizard-required" id="file_id" name="file_id">
...
<script>
        $(document).ready(function() {
            ...
            $('#phone').on('input', function() {
                ...
                phoneHelp.empty(); // Clear previous content

                if (!phoneValue.startsWith('255')) {
                    phoneHelp.html('<i class="fas fa-times-circle text-danger p2"></i> Phone number must start with 255.');
                    phoneHelp.removeClass('text-success').addClass('text-danger');
                    $('#submitButton').prop('disabled', true);
                } else if (phoneValue.length !== 12) {
                    phoneHelp.html('<i class="fas fa-times-circle text-danger p2"></i> Phone number must be exactly 12 digits long.');
                    phoneHelp.removeClass('text-success').addClass('text-danger');
                    $('#submitButton').prop('disabled', true);
                } else {
                    phoneHelp.html('<i class="fas fa-check-circle text-success p2"></i> Phone number looks good.');
                    phoneHelp.removeClass('text-danger').addClass('text-success');
            ...
            $('#myForm').on('submit', function(e) {
                ...
                if (phoneValue.length !== 12 || !phoneValue.startsWith('255')) {
                    e.preventDefault();
                    phoneHelp.html('<i class="fas fa-times-circle text-danger p2"></i> Please enter a valid phone number.');
                    phoneHelp.removeClass('text-success').addClass('text-danger');
                }
            });
        });
