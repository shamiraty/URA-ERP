...
<div class="container">
    ...
    <div class="card basic-data-table">
                    ...
                    <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#createModal">Add Command</button>
                  </div>
                  <div class="card-body">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $command->name }}</td>
                <td>{{ $command->region->name }}</td>
                <td>{{ $command->branch->name }}</td>
                <td>{{ $command->district->name }}</td>
                <td>
